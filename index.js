$( document ).ready(function() {
    ...
    var currentData = {current: [
        {title: "Agent Carter - Season 2 Premiere", date: 'January 19th, 2016', description: "Dedicated to the fight against new atomic age threats in the wake of World War II, Peggy must now journey from New York City to Los Angeles for her most dangerous assignment yet.", logo: 'public/icons/shield.png', banner: 'public/banners/agentcarterS02.png', trailer: 'https://www.youtube.com/watch?v=j7jlEes2q7U', trakt: 'http://trakt.tv/shows/marvel-s-agent-carter/seasons/2'},

        {title: "Agents of Shield - Season 3 Return", date: 'March 8th, 2016', description: "Agent Phil Coulson of S.H.I.E.L.D. (Strategic Homeland Intervention, Enforcement and Logistics Division) puts together a team of agents to investigate the new, the strange and the unknown around the globe, protecting the ordinary from the extraordinary.", logo: 'public/icons/shield.png', banner: 'public/banners/shieldS03.jpg', trakt: 'http://trakt.tv/shows/marvel-s-agents-of-s-h-i-e-l-d/seasons/3'},
    ...
    $("#upcomingList").html(upcomingTemplate(upcomingData));
