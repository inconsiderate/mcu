$( document ).ready(function() {
    ...
    var currentData = {current: [
        ...
        },
        {
            ...
            trailer: 'https://www.youtube.com/watch?v=tx6ws9MAOU8',
        ...
        {   title: "Daredevil - Season 2 Premiere",
            ...
            trailer: 'https://www.youtube.com/watch?v=y44m5739m-4',
    ...
    var data2017 = {upcoming: [
        ...
        {   title: "Iron Fist - Series Premiere",
            date: 'Unknown, 2017',
            description: "'Marvel’s Iron Fist' follows Super Hero and martial arts master Danny Rand in the upcoming live-action series.",
            logo: 'public/icons/defenders.png',
